...
#ifndef AI_MODEL_TEST1_H
#define AI_MODEL_TEST1_H
#pragma once

#include "model_test1_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MODEL_TEST1_MODEL_NAME          "model_test1"
#define AI_MODEL_TEST1_ORIGIN_MODEL_NAME   "model_test"

/******************************************************************************/
#define AI_MODEL_TEST1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_TEST1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_TEST1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_TEST1_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_TEST1_IN \
  ai_model_test1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_TEST1_IN_SIZE { \
  AI_MODEL_TEST1_IN_1_SIZE, \
}
#define AI_MODEL_TEST1_IN_SIZE_BYTES { \
  AI_MODEL_TEST1_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_TEST1_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MODEL_TEST1_IN_1_HEIGHT      (90)
#define AI_MODEL_TEST1_IN_1_WIDTH       (3)
#define AI_MODEL_TEST1_IN_1_CHANNEL     (1)
#define AI_MODEL_TEST1_IN_1_SIZE        (90 * 3 * 1)
#define AI_MODEL_TEST1_IN_1_SIZE_BYTES  (1080)

/******************************************************************************/
#define AI_MODEL_TEST1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_TEST1_OUT \
  ai_model_test1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_TEST1_OUT_SIZE { \
  AI_MODEL_TEST1_OUT_1_SIZE, \
}
#define AI_MODEL_TEST1_OUT_SIZE_BYTES { \
  AI_MODEL_TEST1_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_TEST1_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MODEL_TEST1_OUT_1_CHANNEL     (6)
#define AI_MODEL_TEST1_OUT_1_SIZE        (6)
#define AI_MODEL_TEST1_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_MODEL_TEST1_N_NODES (9)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup model_test1
 ...
 * @ref ai_model_test1_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_test1_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_test1_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_test1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_TEST1_*
 * defines into file @ref model_test1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_model_test1_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODEL_TEST1_H */
