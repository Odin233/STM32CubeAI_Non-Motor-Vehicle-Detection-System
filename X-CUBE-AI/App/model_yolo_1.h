...
#ifndef AI_MODEL_YOLO_1_H
#define AI_MODEL_YOLO_1_H
#pragma once

#include "model_yolo_1_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MODEL_YOLO_1_MODEL_NAME          "model_yolo_1"
#define AI_MODEL_YOLO_1_ORIGIN_MODEL_NAME   "yolo_motor"

/******************************************************************************/
#define AI_MODEL_YOLO_1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_YOLO_1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_YOLO_1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_YOLO_1_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_YOLO_1_IN \
  ai_model_yolo_1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_YOLO_1_IN_SIZE { \
  AI_MODEL_YOLO_1_IN_1_SIZE, \
}
#define AI_MODEL_YOLO_1_IN_SIZE_BYTES { \
  AI_MODEL_YOLO_1_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_YOLO_1_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MODEL_YOLO_1_IN_1_HEIGHT      (128)
#define AI_MODEL_YOLO_1_IN_1_CHANNEL     (128)
#define AI_MODEL_YOLO_1_IN_1_SIZE        (128 * 128)
#define AI_MODEL_YOLO_1_IN_1_SIZE_BYTES  (65536)

/******************************************************************************/
#define AI_MODEL_YOLO_1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_YOLO_1_OUT \
  ai_model_yolo_1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_YOLO_1_OUT_SIZE { \
  AI_MODEL_YOLO_1_OUT_1_SIZE, \
}
#define AI_MODEL_YOLO_1_OUT_SIZE_BYTES { \
  AI_MODEL_YOLO_1_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_YOLO_1_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MODEL_YOLO_1_OUT_1_CHANNEL     (2)
#define AI_MODEL_YOLO_1_OUT_1_SIZE        (2)
#define AI_MODEL_YOLO_1_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_MODEL_YOLO_1_N_NODES (14)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup model_yolo_1
 ...
 * @ref ai_model_yolo_1_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_yolo_1_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_yolo_1_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_yolo_1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_YOLO_1_*
 * defines into file @ref model_yolo_1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_model_yolo_1_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODEL_YOLO_1_H */
