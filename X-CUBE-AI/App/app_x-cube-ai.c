...
AI_ALIGNED(32)
static uint8_t pool0[AI_MODEL_YOLO_1_DATA_ACTIVATION_1_SIZE];
...
void MX_X_CUBE_AI_Process(void)
{
    aiValidationProcess();
    /* USER CODE BEGIN 6 */
	  extern ai_float* aiInData[];
	  extern ai_float* aiOutData;
	  extern int AI_Run_for_model_test1();
    /* USER CODE END 6 */
}
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_MODEL_YOLO_1_MODEL_NAME,
        .config = AI_MODEL_YOLO_1_DATA_CONFIG,
        .ai_get_report = ai_model_yolo_1_get_report,
        .ai_create = ai_model_yolo_1_create,
        .ai_destroy = ai_model_yolo_1_destroy,
        .ai_get_error = ai_model_yolo_1_get_error,
        .ai_init = ai_model_yolo_1_init,
        .ai_run = ai_model_yolo_1_run,
        .ai_forward = ai_model_yolo_1_forward,
        .ai_data_params_get = ai_model_yolo_1_data_params_get,
